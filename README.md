This is a simple calender app that allows users to select a date.This app is made with the help of concepts HTML,CSS and JS.

Firstly to create this app we need to clone the repository and install the dependencies.
...
We need to follow some steps which are given below create this particular application.

The steps are as follows:-

**Step-1**:Creating HTML file with the following code:
...
**Step-2**:Creating CSS file with the following code:
...
**Step-3**:Creating JS file with the following code:
